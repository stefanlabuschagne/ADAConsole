...
Partial Public Class dsVIP_EXPANDED
    ...
    Partial Public Class VIEW_GOVERNMENT_STRUCTUREDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property _NATPROV_DESCRIPTIONColumn() As Global.System.Data.DataColumn
            Get
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVIEW_GOVERNMENT_STRUCTURERow(ByVal NATPROV_SHORT_NAME As String, ByVal NATPROV_DESCRIPTION As String, ByVal FINYEAR As Long) As VIEW_GOVERNMENT_STRUCTURERow
            Dim rowVIEW_GOVERNMENT_STRUCTURERow As VIEW_GOVERNMENT_STRUCTURERow = CType(Me.NewRow,VIEW_GOVERNMENT_STRUCTURERow)
            Dim columnValuesArray() As Object = New Object() {NATPROV_SHORT_NAME, NATPROV_DESCRIPTION, FINYEAR}
        ...
        Private Sub InitClass()
            ...
            Me.columnFINYEAR = New Global.System.Data.DataColumn("FINYEAR", GetType(Long), Nothing, Global.System.Data.MappingType.Element)
            Me.columnFINYEAR.ExtendedProperties.Add("Generator_ColumnPropNameInTable", "_NATPROV_DESCRIPTIONColumn")
            Me.columnFINYEAR.ExtendedProperties.Add("Generator_UserColumnName", "FINYEAR")
    ...
    Partial Public Class VIEW_departmentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVIEW_departmentsRow(ByVal NATPROV_SHORT_NAME As String, ByVal DEPT_SHORT_NAME As String, ByVal DEPT_DESCRIPTION As String, ByVal FINYEAR As Long) As VIEW_departmentsRow
        ...
        Private Sub InitClass()
            ...
            Me.columnFINYEAR = New Global.System.Data.DataColumn("FINYEAR", GetType(Long), Nothing, Global.System.Data.MappingType.Element)
            Me.columnFINYEAR.ExtendedProperties.Add("Generator_ColumnPropNameInTable", "NATPROV_DESCRIPTIONColumn")
            Me.columnFINYEAR.ExtendedProperties.Add("Generator_UserColumnName", "FINYEAR")
            MyBase.Columns.Add(Me.columnFINYEAR)
            Me.columnNATPROV_SHORT_NAME.AllowDBNull = false
            Me.columnNATPROV_SHORT_NAME.MaxLength = 50
    ...
    Partial Public Class VIEW_Assigned_DepartmentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVIEW_Assigned_DepartmentsRow(ByVal DEPT_SHORT_NAME As String, ByVal DEPT_DESCRIPTION As String, ByVal FINYEAR As Long) As VIEW_Assigned_DepartmentsRow
    ...
    Partial Public Class VIEW_GOVERNMENT_STRUCTURERow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Property FINYEAR() As Long
            Get
                Return CType(Me(Me.tableVIEW_GOVERNMENT_STRUCTURE._NATPROV_DESCRIPTIONColumn),Long)
            End Get
            Set
                Me(Me.tableVIEW_GOVERNMENT_STRUCTURE._NATPROV_DESCRIPTIONColumn) = value
            End Set
        End Property
    End Class
    ...
    Partial Public Class VIEW_departmentsRow
        ...
        Public Property FINYEAR() As Long
            Get
                Return CType(Me(Me.tableVIEW_departments.NATPROV_DESCRIPTIONColumn),Long)
            End Get
            Set
                Me(Me.tableVIEW_departments.NATPROV_DESCRIPTIONColumn) = value
            End Set
        End Property
    End Class
    ...
    Partial Public Class VIEW_Assigned_DepartmentsRow
        ...
        Public Property FINYEAR() As Long
            Get
                Try 
                    Return CType(Me(Me.tableVIEW_Assigned_Departments.FINYEARColumn),Long)
                Catch e As Global.System.InvalidCastException
...
Namespace dsVIP_EXPANDEDTableAdapters
    ...
    Partial Public Class ta_VIEW_GOVERNMENT_STRUCTURE
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT DISTINCT NATPROV_SHORT_NAME, NATPROV_DESCRIPTION FROM VIEW_GOVERNMENT_STRU"& _ 
                "CTURE_FYEAR"
    ...
    Partial Public Class VIEW_departmentsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT DISTINCT NATPROV_SHORT_NAME, DEPT_SHORT_NAME, DEPT_DESCRIPTION, FINYEAR FR"& _ 
                "OM VIEW_GOVERNMENT_STRUCTURE_FYEAR ORDER BY 1,2,4"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(1).CommandText = "SELECT DISTINCT NATPROV_SHORT_NAME, NATPROV_DESCRIPTION, DEPT_SHORT_NAME, DEPT_DE"& _ 
                "SCRIPTION, FINYEAR FROM VIEW_GOVERNMENT_STRUCTURE_FYEAR WHERE (NATPROV_SHORT_NAM"& _ 
                "E = @NatProvShort) ORDER BY NATPROV_SHORT_NAME,DEPT_SHORT_NAME,FINYEAR"
    ...
    Partial Public Class ta_VIEW_Assigned_Departments
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT DISTINCT DEPT_SHORT_NAME, DEPT_DESCRIPTION,FINYEAR FROM VIEW_ADADMIN_DEPT_"& _ 
                "HISTORY ORDER BY 1,3"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class ta_VIEW_APPLICATION_RIGHTS
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT RTRIM(LTRIM(GROUP_SHORT_NAME)) + '.' + RTRIM(LTRIM(SECLEVEL_NAME)) AS GROU"& _ 
                "P_SEC, SECLEVEL_DESCRIPTION FROM VIEW_APPLICATION_RIGHTS"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
