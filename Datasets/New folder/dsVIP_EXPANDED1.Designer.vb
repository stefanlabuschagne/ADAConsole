...
Partial Public Class dsVIP_EXPANDED
    ...
    Partial Public Class VIEW_GOVERNMENT_STRUCTUREDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVIEW_GOVERNMENT_STRUCTURERow(ByVal NATPROV_SHORT_NAME As String, ByVal NATPROV_DESCRIPTION As String, ByVal FINYEAR As Integer) As VIEW_GOVERNMENT_STRUCTURERow
