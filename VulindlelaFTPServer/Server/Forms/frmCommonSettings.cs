...
{
    internal partial class frmCommonSettings : Form
    {
        ...
        void Save_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    MessageBox.Show("HTTP service is already disabled. Notify icon option is required for Management.", "Vulindlela FTP Server");
