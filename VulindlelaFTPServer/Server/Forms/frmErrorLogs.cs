...
{
    internal partial class frmErrorLogs : Form
    {
        DataTable LogList=null;
        bool CancelSearch;
        ...
        void Searcher_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //    MessageBox.Show("No results to display.", "Vulindlela FTP Server");
            //    return;
            //}
        ...
        {
            CancelSearch =
                MessageBox.Show("Are you sure to cancel the searching operation?", "Vulindlela FTP Server",
