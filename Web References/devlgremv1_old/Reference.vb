...
Namespace devlgremv1_old
    ...
    Partial Public Class LOG_DM_Customer_Information_BasicWS__cService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.ADAdminDotNet.My.MySettings.Default.ADAdminConsole_devlgremv1_LOG_DM_Customer_Information_BasicWS__cService
        ...
        Public Sub [Set](ByVal Last_Name As String, ByVal Telephone As String, ByVal Fax_Number As String, <System.Xml.Serialization.XmlElementAttribute("E-Mail"), System.ComponentModel.DefaultValueAttribute("None")> ByVal EMail As String, ByVal Nickname As String, ByVal Cellphone As String, ByVal Extension As String, ByVal VULIN_Store_Number As String, ByRef Entry_ID As String, ByVal VULINDLELA_Role As String, <System.Xml.Serialization.XmlAttributeAttribute()> ByVal Title As String, <System.Xml.Serialization.XmlAttributeAttribute()> ByVal First_Name As String, <System.Xml.Serialization.XmlAttributeAttribute()> ByVal Persal_Number As String)
            Dim results() As Object = Me.Invoke("Set", New Object() {Last_Name, Telephone, Fax_Number, EMail, Nickname, Cellphone, Extension, VULIN_Store_Number, Entry_ID, VULINDLELA_Role, Title, First_Name, Persal_Number})
            Entry_ID = CType(results(0),String)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SetAsync(ByVal Last_Name As String, ByVal Telephone As String, ByVal Fax_Number As String, ByVal EMail As String, ByVal Nickname As String, ByVal Cellphone As String, ByVal Extension As String, ByVal VULIN_Store_Number As String, ByVal Entry_ID As String, ByVal VULINDLELA_Role As String, ByVal Title As String, ByVal First_Name As String, ByVal Persal_Number As String)
            Me.SetAsync(Last_Name, Telephone, Fax_Number, EMail, Nickname, Cellphone, Extension, VULIN_Store_Number, Entry_ID, VULINDLELA_Role, Title, First_Name, Persal_Number, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SetAsync(ByVal Last_Name As String, ByVal Telephone As String, ByVal Fax_Number As String, ByVal EMail As String, ByVal Nickname As String, ByVal Cellphone As String, ByVal Extension As String, ByVal VULIN_Store_Number As String, ByVal Entry_ID As String, ByVal VULINDLELA_Role As String, ByVal Title As String, ByVal First_Name As String, ByVal Persal_Number As String, ByVal userState As Object)
            If (Me.SetOperationCompleted Is Nothing) Then
                Me.SetOperationCompleted = AddressOf Me.OnSetOperationCompleted
            End If
            Me.InvokeAsync("Set", New Object() {Last_Name, Telephone, Fax_Number, EMail, Nickname, Cellphone, Extension, VULIN_Store_Number, Entry_ID, VULINDLELA_Role, Title, First_Name, Persal_Number}, Me.SetOperationCompleted, userState)
        End Sub
