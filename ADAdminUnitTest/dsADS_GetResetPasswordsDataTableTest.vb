...
'''<summary>
'''This is a test class for dsADS_GetResetPasswordsDataTableTest and is intended
'''to contain all dsADS_GetResetPasswordsDataTableTest Unit Tests
'''</summary>
<TestClass()> _
Public Class dsADS_GetResetPasswordsDataTableTest
...
<TestMethod()>  _
Public Sub ItemTest()
Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable ' TODO: Initialize to an appropriate value
...
'''<summary>
'''A test for RemoveGetResetPasswordsRow
'''</summary>
<TestMethod()>  _
Public Sub RemoveGetResetPasswordsRowTest()
Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable ' TODO: Initialize to an appropriate value
Dim row As dsADS.GetResetPasswordsRow = Nothing ' TODO: Initialize to an appropriate value
    target.RemoveGetResetPasswordsRow(row)
...
Dim target As dsADS_Accessor.GetResetPasswordsDataTable = New dsADS_Accessor.GetResetPasswordsDataTable ' TODO: Initialize to an appropriate value
...
'''<summary>
'''A test for NewGetResetPasswordsRow
'''</summary>
<TestMethod()>  _
Public Sub NewGetResetPasswordsRowTest()
Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable ' TODO: Initialize to an appropriate value
Dim expected As dsADS.GetResetPasswordsRow = Nothing ' TODO: Initialize to an appropriate value
    Dim actual As dsADS.GetResetPasswordsRow
    actual = target.NewGetResetPasswordsRow
    Assert.AreEqual(expected, actual)
    Assert.Inconclusive("Verify the correctness of this test method.")
End Sub
...
Dim expected As XmlSchemaComplexType = Nothing ' TODO: Initialize to an appropriate value
    ...
    actual = dsADS.GetResetPasswordsDataTable.GetTypedTableSchema(xs)
    Assert.AreEqual(expected, actual)
    Assert.Inconclusive("Verify the correctness of this test method.")
End Sub
...
'''<summary>
'''A test for AddGetResetPasswordsRow
'''</summary>
<TestMethod()>  _
Public Sub AddGetResetPasswordsRowTest1()
Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable ' TODO: Initialize to an appropriate value
Dim row As dsADS.GetResetPasswordsRow = Nothing ' TODO: Initialize to an appropriate value
    target.AddGetResetPasswordsRow(row)
    Assert.Inconclusive("A method that does not return a value cannot be verified.")
End Sub
...
'''</summary>
<TestMethod()>  _
Public Sub AddGetResetPasswordsRowTest()
Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable ' TODO: Initialize to an appropriate value
Dim Expr1 As Integer = 0 ' TODO: Initialize to an appropriate value
Dim expected As dsADS.GetResetPasswordsRow = Nothing ' TODO: Initialize to an appropriate value
    Dim actual As dsADS.GetResetPasswordsRow
    actual = target.AddGetResetPasswordsRow(Expr1)
    Assert.AreEqual(expected, actual)
    Assert.Inconclusive("Verify the correctness of this test method.")
End Sub

'''<summary>
'''A test for GetResetPasswordsDataTable Constructor
'''</summary>
<TestMethod()>  _
Public Sub dsADS_GetResetPasswordsDataTableConstructorTest2()
    Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable
...
'''</summary>
<TestMethod()>  _
Public Sub dsADS_GetResetPasswordsDataTableConstructorTest1()
Dim table As DataTable = Nothing ' TODO: Initialize to an appropriate value
    Dim target As dsADS.GetResetPasswordsDataTable = New dsADS.GetResetPasswordsDataTable(table)
    Assert.Inconclusive("TODO: Implement code to verify target")
End Sub
...
<TestMethod(),  _
 DeploymentItem("ADAdminDotNet.exe")>  _
Public Sub dsADS_GetResetPasswordsDataTableConstructorTest()
...
Dim context As StreamingContext = New StreamingContext ' TODO: Initialize to an appropriate value
    Dim target As dsADS_Accessor.GetResetPasswordsDataTable = New dsADS_Accessor.GetResetPasswordsDataTable(info, context)
    Assert.Inconclusive("TODO: Implement code to verify target")
End Sub
End Class
