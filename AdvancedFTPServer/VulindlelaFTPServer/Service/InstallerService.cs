...
namespace WindowsService
{
    ...
    public class InstallerService : Installer
    {
        ...
        public InstallerService()
        {
            ...
            serviceInstaller.DisplayName = "Vulindlela FTP Server";
            ...
            serviceInstaller.ServiceName = "VulFTPSvr";
            this.Installers.Add(serviceInstaller);
        }
        ...
        protected override void OnCommitted(IDictionary savedState)
        {
            ...
            EncryptSettingsFile(ApplicationPath + "\\Settings.XML");
            AddToFirewallException(serviceInstaller.DisplayName, ApplicationPath + "\\VulFTPServer.exe");
        ...
        //    Registry.ClassesRoot.DeleteSubKey(@"Folder\shell\VulindlelaFTPServer\command", false);
        //    Registry.ClassesRoot.DeleteSubKey(@"Folder\shell\VulindlelaFTPServer", false);
        ...
        //    try
        //    {
        //        RegistryKey RegKey = Registry.ClassesRoot.CreateSubKey(@"Folder\shell\VulindlelaFTPServer");
        //        if (RegKey != null)
        //        {
        //            RegKey.SetValue("", MenuText);
        //            RegKey.Close();

        //            RegKey = Registry.ClassesRoot.CreateSubKey(@"Folder\shell\VulindlelaFTPServer\command");
        //            if (RegKey != null)
        //            {
