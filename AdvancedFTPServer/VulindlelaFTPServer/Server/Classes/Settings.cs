       ...
       // internal static HTTPServer HttpServer;
        ...
        internal static void SaveSettings()
        {
            try
            {
                ...
                FileStream FS = new FileStream(DataPath + "Settings.xml", FileMode.Create, FileAccess.Write);
            ...
            try
            {
                if (Directory.Exists(Path))
                {
                    ...
                    if (File.Exists(IconFileInfo))
                    {
                        ...
                        DeleteFile = (SR.BaseStream.Length < 1024 && SR.ReadToEnd().IndexOf("SET_BY_VulFTPSvr") != -1);
                        SR.Close(); SR = null;
