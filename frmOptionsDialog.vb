...
Public Class frmOptionsDialog
    ...
    Private Sub tsBtnSAVE_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsBtnSAVE.Click
        ...
        ' My.MySettings.Default.PropertyValues("AD_Users_PRD").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).AD_Users_PRD
        ''My.MySettings.Default.PropertyValues("AD_Users_QA").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).AD_Users_QA
        ''My.MySettings.Default.PropertyValues("ADSConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSConnectionString
        ''My.MySettings.Default.PropertyValues("ADSMasterPassword_PRD").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSMasterPassword_PRD
        ''My.MySettings.Default.PropertyValues("ADSMasterPassword_QA").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSMasterPassword_QA
        ''My.MySettings.Default.PropertyValues("ADSPRDConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSPRDConnectionString
        ''My.MySettings.Default.PropertyValues("ADSPRDConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSPRDConnectionString
        ''My.MySettings.Default.PropertyValues("ADSQAConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSQAConnectionString
        ''My.MySettings.Default.PropertyValues("ADSQAConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ADSQAConnectionString
        ''My.MySettings.Default.PropertyValues("ARPassword").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ARPassword
        ''My.MySettings.Default.PropertyValues("ARSystemConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ARSystemConnectionString
        ''My.MySettings.Default.PropertyValues("DeptDescPair").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).DeptDescPair
        ''My.MySettings.Default.PropertyValues("HelpDesk_PhoneNo").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).HelpDesk_PhoneNo
        ''My.MySettings.Default.PropertyValues("ARUser").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ARUser
        ''My.MySettings.Default.PropertyValues("SMTPServerIPAddress").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).SMTPServerIPAddress
        ''My.MySettings.Default.PropertyValues("VIP_ExpandedConnectionString").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).VIP_ExpandedConnectionString
        ''My.MySettings.Default.PropertyValues("WebBrowserEXE").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).DefaultWebBrowserEXE
        ''My.MySettings.Default.PropertyValues("ARSServerName").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ARSServerName
        ''My.MySettings.Default.PropertyValues("RemedyServerName").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).RemedyServerName
        ''My.MySettings.Default.PropertyValues("Vulindlela_Controllers").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).Vulindlela_Controllers
        ''My.MySettings.Default.PropertyValues("ProxyOveride").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ProxyOveride
        ''My.MySettings.Default.PropertyValues("ProxyOverideCurrent").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).ProxyOverideCurrent
        ''My.MySettings.Default.PropertyValues("VulindlelaUser").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).VulindlelaUser
        ''My.MySettings.Default.PropertyValues("Close_Pick_Forms").PropertyValue = DirectCast(appaaa, AdAdminConfigs.AppSettings).Close_Pick_Forms
