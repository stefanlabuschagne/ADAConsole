...
Public NotInheritable Class PublicationFactory
	...
	Public Shared Function DeltaMaker(oldDataSet As DataSet, newDataSet As DataSet) As DataSet
...
Friend NotInheritable Class TTSDataHelper
	...
	Public Shared Sub BeginSerializeHelper(dataset As DataSet)
	...
	Public Shared Sub EndSerializeHelper(dataSet As DataSet)
		For Each table As DataTable In dataSet.Tables
