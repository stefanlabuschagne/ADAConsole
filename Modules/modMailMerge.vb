...
Module modMailMerge
    ...
    Public Function ParseFile_Email(ByVal TemplateFilePath As String, _
        ...
        '' Just for test 
        EmailMessage.Sender = New MailAddress(returnaddress)
        ...
        Try
            ...
            logo = New LinkedResource(apppath & "NTlogo.jpg")
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(ex.InnerException.ToString(), smtp.Host)
    ...
    Public Function ParseFile_EMail_To_Verify_Against_Establishment(ByVal TemplateFilePath As String, _
        ...
        ParseFile_EMail_To_Verify_Against_Establishment = ""
        Dim t As TextReader
        Dim i As Integer, j As Integer, a() As String, fil As String
        Dim EmailMessage As MailMessage = New MailMessage
        Dim thisusername As String
    ...
    Public Function ParseFile_Vulindlela_User_Account_Reset(ByVal TemplateFilePath As String, _
                              ByVal FieldAndValues As Collection) As String
        ParseFile_Vulindlela_User_Account_Reset = ""
        Dim t As TextReader
        Dim i As Integer, j As Integer, a() As String, fil As String
        Dim EmailMessage As MailMessage = New MailMessage
        Dim thisusername As String
        ...
        EmailMessage.To.Add(Replace(FieldAndValues.Item(3).ToString, "EMail_Address=", ""))
        ...
        EmailMessage.IsBodyHtml = True
        Dim smtp As New SmtpClient(My.Settings.SMTPServerIPAddress.Trim)
        If MsgBox("Force a Password change as well?", MsgBoxStyle.YesNo, "System Message") = MsgBoxResult.Yes Then
    ...
    Public Function ParseFileAspTags(ByVal TemplateFilePath As String, _
        ...
        k.ReadLine()
        ' Gets the value from FieldAndValues that gets passed here
        EmailMessage.To.Add(Replace(FieldAndValues(3).ToString, "EMail_Address=", ""))
