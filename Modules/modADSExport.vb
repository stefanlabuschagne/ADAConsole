...
Module modADSExport
    ...
    Public Sub Create_Snapshot()
        ...
        Dim cnVIP_EXP As New SqlClient.SqlConnection

        cnVIP_EXP.ConnectionString = My.Settings.VIP_EXPANDEDConnectionString

        Dim cnADS2 As New SqlClient.SqlConnection
        Dim cnADS As New SqlClient.SqlConnection

        cnADS.ConnectionString = My.Settings.AdsConnectionString
        cnADS2.ConnectionString = My.Settings.AdsConnectionString

        Dim cmdADS2 As New SqlClient.SqlCommand("AD_SNAPSHOT_ALL_INSERT", cnADS)
        Dim cmdADS3 As New SqlClient.SqlCommand("AD_SNAPSHOT_ALL_DELETE_ALL", cnADS)
        Dim cmdADS4 As New SqlClient.SqlCommand("GetPROVDescription", cnADS2)
        Dim cmdADS5 As New SqlClient.SqlCommand("GetSNAMEDept", cnADS2)
        ...
        Dim pUCount As New SqlClient.SqlParameter("@UCount", SqlDbType.BigInt)
        Dim pPersalnr As New SqlClient.SqlParameter("@PersalNr", SqlDbType.VarChar, 8)
        Dim pAccountNr As New SqlClient.SqlParameter("@AccountNr", SqlDbType.VarChar, 9)
        Dim pNatProv As New SqlClient.SqlParameter("@NatProv ", SqlDbType.VarChar, 20)
        Dim pVote As New SqlClient.SqlParameter("@Vote", SqlDbType.VarChar, 55)
        Dim pDeptCode As New SqlClient.SqlParameter("@DeptCode", SqlDbType.VarChar, 9)
        Dim pEMail As New SqlClient.SqlParameter("@EMail", SqlDbType.VarChar, 150)
        Dim pCell As New SqlClient.SqlParameter("@Cell", SqlDbType.VarChar, 20)
        Dim pPhone As New SqlClient.SqlParameter("@Phone", SqlDbType.VarChar, 20)
        Dim pFirstName As New SqlClient.SqlParameter("@FirstName", SqlDbType.VarChar, 20)
        Dim pLastname As New SqlClient.SqlParameter("@Lastname", SqlDbType.VarChar, 40)
        Dim pApplMember As New SqlClient.SqlParameter("@ApplMember", SqlDbType.VarChar, 500)
        Dim pDeptMember As New SqlClient.SqlParameter("@DeptMember", SqlDbType.VarChar, 4000)
        Dim pDepartment As New SqlClient.SqlParameter("@Department", SqlDbType.VarChar, 10)
        Dim pAccountDisabled As New SqlClient.SqlParameter("@AccountDisabled", SqlDbType.SmallInt)
        Dim pLOGIS As New SqlClient.SqlParameter("@LOGIS", SqlDbType.SmallInt)
        Dim pHR As New SqlClient.SqlParameter("@HR", SqlDbType.SmallInt)
        Dim pFINANCIALS As New SqlClient.SqlParameter("@FINANCIALS", SqlDbType.SmallInt)
        Dim pGFS As New SqlClient.SqlParameter("@GFS", SqlDbType.SmallInt)
        Dim pDPSA As New SqlClient.SqlParameter("@DPSA", SqlDbType.SmallInt)
        Dim pSNAME As New SqlClient.SqlParameter("@SNAME", SqlDbType.VarChar, 9)
